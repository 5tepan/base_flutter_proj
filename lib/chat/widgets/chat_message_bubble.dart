...
class ChatMessageBubble extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final bubbleColor =
        isOutgoing ? style.outgoingBubbleColor : style.incomingBubbleColor;
    final textColor =
        isOutgoing ? style.outgoingTextColor : style.incomingTextColor;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(message.text, style: AppTextStyle.body.copyWith(color: textColor)),
